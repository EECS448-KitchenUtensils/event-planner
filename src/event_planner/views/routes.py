...
def show_event_get(event_id):
    ...
    # TESTING
    parts = [['John', ['9:00 am', '11:00 am', '1:00 pm']], ['Tony', ['10:00 am']], ['Armaan', ['10:00 am']], ['Jack', ['10:00 am']]]
    ...
    return render_template('event_view.html', event=event, daterange=daterange, daterange24=daterange24, participants=parts)
